#pragma once
// B-2 baseline (T1) tests - minimal self-registration harness.
//
...
// binary; every test here is prefixed baseline_.
//
// This suite is the plan-stage oracle for Tier 1 (docs/stencils.md SS7/SS9,
// docs/cpp26_standards.md Part B golden/stability discipline): every
// assertion encodes the frozen contracts of include/b2/baseline/
// {Stencil.h, Stencil.h, Plan.h, Compiler.h} - manifest shape, availability
// map, plan invariants, refusal reasons, and the deterministic dump.
